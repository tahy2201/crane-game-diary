...
export type NewGroup = Omit<
  InferInsertModel<typeof groups>,
  'group_id' | 'created_at'
>;
...
export type NewInviteToken = Omit<
  InferInsertModel<typeof inviteTokens>,
  'token_id' | 'created_at'
>;

// ---------- Arcades ----------
export type Arcade = InferSelectModel<typeof arcades>;
export type NewArcade = Omit<
  InferInsertModel<typeof arcades>,
  'arcade_id' | 'created_at'
>;

// ---------- PrizeCategories ----------
export type PrizeCategory = InferSelectModel<typeof prizeCategories>;
export type NewPrizeCategory = Omit<
  InferInsertModel<typeof prizeCategories>,
  'prize_category_id'
>;

// ---------- CraneTypes ----------
export type CraneType = InferSelectModel<typeof craneTypes>;
export type NewCraneType = Omit<
  InferInsertModel<typeof craneTypes>,
  'crane_type_id'
>;

// ---------- Prizes ----------
export type Prize = InferSelectModel<typeof prizes>;
export type NewPrize = Omit<
  InferInsertModel<typeof prizes>,
  'prize_id' | 'created_at'
>;

// ---------- Plays ----------
export type Play = InferSelectModel<typeof plays>;
export type NewPlay = Omit<
  InferInsertModel<typeof plays>,
  'play_id' | 'created_at'
>;
